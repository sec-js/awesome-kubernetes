...
!!! info "Architectural Context"
  ...
  - [Zepto is a lightweight framework for the development of microservices & web services in golang](https://github.com/go-zepto/zepto)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [dev.to: Deploying Your First Golang Webapp](https://dev.to/heroku/deploying-your-first-golang-webapp-11b3)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [eli.thegreenplace.net: REST Servers in Go: Part 4 - using OpenAPI and Swagger](https://eli.thegreenplace.net/2021/rest-servers-in-go-part-4-using-openapi-and-swagger)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [blog.getambassador.io: Debugging Go Microservices in Kubernetes with VScode](https://blog.getambassador.io/debugging-go-microservices-in-kubernetes-with-vscode-a36beb48ef1)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [developers.redhat.com: Using Delve to debug Go programs on Red Hat Enterprise Linux](https://developers.redhat.com/blog/2021/03/03/using-delve-to-debug-go-programs-on-red-hat-enterprise-linux)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [The Ultimate Go Study Guide](https://github.com/hoanhan101/ultimate-go)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [developer.okta.com: Elasticsearch in Go: A Developer's Guide](https://developer.okta.com/blog/2021/04/23/elasticsearch-go-developers-guide)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [go-ini/ini](https://github.com/go-ini/ini)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [rakyll/go-test-trace 🌟](https://github.com/rakyll/go-test-trace)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [thenewstack.io: Getting Started with Go and InfluxDB](https://thenewstack.io/getting-started-with-go-and-influxdb)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [blog.logrocket.com: Building a simple app with Go and PostgreSQL](https://blog.logrocket.com/building-simple-app-go-postgresql)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [datastation.multiprocess.io: Speeding up Go's builtin JSON encoder up to 55% for large arrays of objects](https://datastation.multiprocess.io/blog/2022-03-03-improving-go-json-encoding-performance-for-large-arrays-of-objects.html)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [iximiuz.com: How To Call Kubernetes API using Go - Types and Common Machinery](https://iximiuz.com/en/posts/kubernetes-api-go-types-and-common-machinery)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [dev.to: Watch and react to Kubernetes objects changes](https://dev.to/lucasepe/watch-and-react-to-kubernetes-objects-changes-3kcg)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [collabnix.com: Kubernetes CRUD Operation using Go on Docker Desktop](https://collabnix.com/kubernetes-crud-operation-using-go-on-docker-desktop)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [gnet](https://github.com/panjf2000/gnet)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [dsa0x/sicher](https://github.com/dsa0x/sicher)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [ggicci/httpin: HTTP Input for Go](https://github.com/ggicci/httpin)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [curl-to-go](https://mholt.github.io/curl-to-go)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [kkdai/youtube](https://github.com/kkdai/youtube)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [github.com/iawia002/lux 🌟](https://github.com/iawia002/lux)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [github.com/Email-Dashboard:](https://github.com/Email-Dashboard/Email-Dashboard)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [gobrew 🌟](https://github.com/kevincobain2000/gobrew)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [github.com/groundcover-com: Container Restarts Watcher](https://github.com/groundcover-com/blog/tree/main/blog_k8s_containers_restarts)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [create-go-app/cli](https://github.com/create-go-app/cli)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [Delve: a debugger for the Go Programming Language](https://github.com/derekparker/delve)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [inancgumus/learngo 🌟](https://github.com/inancgumus/learngo)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [GoogleCloudPlatform/golang-samples: Sample apps and code written for Google Cloud in the Go programming language.](https://github.com/GoogleCloudPlatform/golang-samples)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [rehacktive/caffeine](https://github.com/rehacktive/caffeine)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [ebosas/microservices](https://github.com/ebosas/microservices)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
