...
!!! info "Architectural Context"
  ...
  - [developers.redhat.com: Red Hat Software Collections](https://developers.redhat.com/blog/2018/11/15/rhel8-introducing-appstreams)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [developers.redhat.com: Red Hat Developer Toolset](https://developers.redhat.com/products/red-hat-developer-toolset)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [Amazon CodeGuru Reviewer](https://aws.amazon.com/codeguru/profiler)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [El camino del Frontend Developer](https://github.com/mrcodedev/frontend-developer-resources)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
