...
#### General Reference
  ...
  - [developers.redhat.com: Red Hat Software Collections](https://developers.redhat.com/blog/2018/11/15/rhel8-introducing-appstreams)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span> — A curated technical resource and architectural guide covering developers.redhat.com in the Kubernetes Tools ecosystem.
  - [developers.redhat.com: Red Hat Developer Toolset](https://developers.redhat.com/products/red-hat-developer-toolset)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span> — A curated technical resource and architectural guide covering developers.redhat.com in the Kubernetes Tools ecosystem.
