...
!!! info "Architectural Context"
  ...
  - [CRI-O](https://cri-o.io)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [Podman & Buildah for docker users](https://developers.redhat.com/blog/2019/02/21/podman-and-buildah-for-docker-users)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [OLM operator lifecycle manager](https://github.com/operator-framework/operator-lifecycle-manager)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [developers.redhat.com: Welcome to the Developer Sandbox for Red Hat OpenShift](https://developers.redhat.com/developer-sandbox)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
