...
#### Low-Level Engines
  ...
  - **(2015)** [==runc==](https://github.com/opencontainers/runc) <span class='md-tag md-tag--info'>⭐ 13281</span> <span class='md-tag md-tag--warning'>[GO CONTENT]</span> <span class='md-tag md-tag--critical'>[ADVANCED LEVEL]</span> 🌟🌟🌟🌟🌟 <span class='md-tag md-tag--success'>[DE FACTO STANDARD]</span> — The canonical, low-level container runtime engine built in compliance with the OCI specification. Originally contributed by Docker, runc directly spawns and runs containers on Linux by interfacing with namespaces, cgroups, and capabilities without relying on overhead daemons.
