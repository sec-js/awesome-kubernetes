...
!!! info "Architectural Context"
  ...
  - [docs.openshift.com 🌟](https://docs.redhat.com/en)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [github.com/openshift/origin 🌟](https://github.com/openshift/origin)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [OpenShift Dedicated](https://www.redhat.com/en/technologies/cloud-computing/openshift/dedicated)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [Portfolio Architecture WorkShops 🌟](https://redhatdemocentral.gitlab.io/portfolio-architecture-workshops/#)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [Portfolio Architecture Tooling](https://redhatdemocentral.gitlab.io/portfolio-architecture-tooling)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [gitlab.com: Portfolio Architecture Examples](https://gitlab.com/redhatdemocentral/portfolio-architecture-examples)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [github.com/openshift/installer openshift installer 🌟](https://github.com/openshift/installer)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [Deploying OpenShift 4.4 to VMware vSphere 7 🌟](https://www.redhat.com/en/blog/deploying-openshift-4.4-to-vmware-vsphere-7)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [GitHub: redhat-cop OpenShift Toolkit Network Policy 🌟](https://github.com/redhat-cop/openshift-toolkit/tree/master/networkpolicy)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [How to Enable Static Egress IP in OCP](https://www.redhat.com/en/blog/how-to-enable-static-egress-ip-in-ocp)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [github.com/sclorg/mariadb-container](https://github.com/sclorg/mariadb-container)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
