...
#### Mobile Administration
  ...
  - **(2025)** [**kubenav**](https://github.com/kubenav/kubenav) <span class='md-tag md-tag--info'>⭐ 2273</span> <span class='md-tag md-tag--warning'>[DART CONTENT]</span> 🌟🌟🌟🌟 <span class='md-tag md-tag--info'>[ENTERPRISE-STABLE]</span> — A lightweight multi-platform open-source navigator designed for mobile devices (iOS, Android) and desktop. Delivers secure cluster troubleshooting, rapid log auditing, and safe shell executions directly on remote servers.
