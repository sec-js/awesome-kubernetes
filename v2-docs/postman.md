...
!!! info "Architectural Context"
    Detailed reference for Postman in the context of Developer Ecosystem.
  ...
  - [Newman](https://github.com/postmanlabs/newman)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
