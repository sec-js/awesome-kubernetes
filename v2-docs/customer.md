...
## Standard Reference
  ...
  - [genbeta.com: El software de los coches de Mercedes contiene código abierto' y en vez de distribuirlo en GitHub usan un CD](https://www.genbeta.com/desarrollo/software-coches-mercedes-contiene-codigo-abierto-vez-distribuirlo-github-usan-cd)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [chaimeleon.eu](https://chaimeleon.eu)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [valenciaplaza.com: El IIS La Fe liderará la dirección científica del Nodo' Central del Atlas de Imágenes en Cáncer](https://valenciaplaza.com/iis-fe-liderara-direccion-cientifica-nodo-central-atlas-imagenes-cancer)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [aws.amazon.com: Accelerating radiology imaging workflows with relevant clinical' context on AWS](https://aws.amazon.com/blogs/industries/accelerating-radiology-imaging-workflows-with-relevant-clinical-context-on-aws)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [biobanking.com: Europe’s Leading Cancer Image Biobank (EUCAIM) Launched' by Quibim and European Commission](https://www.biobanking.com/europes-leading-cancer-image-biobank-eucaim-launched-by-quibim-and-european-commission)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [nature.com: Quibim: empowering biopharma to turn images into actionable' predictions using artificial intelligence](https://www.nature.com/articles/d43747-023-00028-w)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [falco.org/about/case-studies/incepto-medical: Protect shared clusters for' medical imaging](https://falco.org/about/case-studies/incepto-medical)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
