...
1. [Kubernetes Core](#kubernetes-core)
  ...
  - [Releases](#releases)
    - [v1.25](#v125-2)
    - [v1.26 Analysis](#v126-analysis)
    - [v1.26 Features](#v126-features)
    - [v1.27](#v127)
    - [v1.27 Features](#v127-features)
    - [v1.27 Industry](#v127-industry)
    - [v1.27 Security](#v127-security)
...
1. [Kubernetes Orchestration](#kubernetes-orchestration)
  - [Batch Jobs](#batch-jobs)
    - [Job Tracking](#job-tracking)
1. [Kubernetes Security](#kubernetes-security)
  - [Policies](#policies)
    - [CEL Admission](#cel-admission)
    - [Deprecation Critique](#deprecation-critique)
    - [Pod Security Policy](#pod-security-policy)
1. [Kubernetes Storage](#kubernetes-storage)
  - [CSI](#csi)
