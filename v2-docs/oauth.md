...
#### OIDC
  ...
  - **(2023)** [==curity.io: OpenID Connect Overview==](https://curity.io/resources/learn/openid-connect-overview) <span class='md-tag md-tag--warning'>[EN CONTENT]</span> 🌟🌟🌟🌟🌟 <span class='md-tag md-tag--success'>[DE FACTO STANDARD]</span> <details class='v2-inline-summary'><summary class='md-tag md-tag--info'>Deep-Dive</summary><div class='v2-summary-wrapper' markdown='1'>
