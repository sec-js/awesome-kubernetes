...
!!! info "Architectural Context"
    Detailed reference for Testops in the context of Platform & Site Reliability.
  ...
  - [Smocker (server mock) is a simple and efficient HTTP mock server](https://github.com/smocker-dev/smocker)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [copyist](https://github.com/cockroachdb/copyist)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [synopsys.com: How to integrate automated AST tools in your CI/CD pipeline](https://www.blackduck.com)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
