...
#### Case Studies
  ...
  - **(2021)** [weave.works: Case Study: National Australia Bank Decreases Operational Overhead with GitOps](https://www.weave.works/blog/case-study-national-australia-bank-decreases-operational-overhead-with-gitops) <span class='md-tag md-tag--critical'>[ADVANCED LEVEL]</span>  <span class='md-tag md-tag--secondary'>[CASE STUDY]</span> <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span> — Examines how National Australia Bank (NAB) utilized GitOps to minimize deployment friction, satisfy stringent compliance audits, and dramatically reduce operational overhead. Illustrates real-world recovery from multi-region outages using declarative definitions.
#### Scale
