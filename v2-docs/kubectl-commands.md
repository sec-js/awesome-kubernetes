...
!!! info "Architectural Context"
  ...
  - [ibm.com: 8 Kubernetes Tips and Tricks 🌟](https://www.ibm.com/think/insights/8-kubernetes-tips-and-tricks)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [superbrothers/zsh-kubectl-prompt 🌟](https://github.com/superbrothers/zsh-kubectl-prompt)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [ahmetb/kubectl-aliases](https://github.com/ahmetb/kubectl-aliases)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [github.com/trstringer/kubectl-example](https://github.com/trstringer/kubectl-example)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [Kubernetes productivity tips and tricks 🌟](https://www.theodo.com/expertise/cloud)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  - [complete-alias](https://github.com/cykerway/complete-alias)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
  ...
  - [Manage Kubernetes (K8s) objects](https://docs.ansible.com/projects/ansible/latest/collections/kubernetes/core/k8s_module.html)  <span class='md-tag md-tag--info'>[COMMUNITY-TOOL]</span>
