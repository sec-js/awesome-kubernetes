...
| [Introduction](docs/introduction.md) | 321 |
| [Managed Kubernetes In Public Cloud](docs/managed-kubernetes-in-public-cloud.md) | 306 |
<!-- TOP_CATEGORIES_END -->
...
| 9 | 2026 | 1606 | 6,632 | **Agentic AI Surge** (May 2026 Inception) |
<!-- ANNUAL_GROWTH_END -->
...
xychart-beta
    ...
    bar [1445, 586, 8449, 2193, 1660, 123, 218, 20, 6632]
    bar [350, 142, 2046, 531, 402, 30, 53, 5, 1606]
```
<!-- ANNUAL_CHART_END -->
...
| 2026-05 | 1581 | 6,529 | **Agentic Inception (Gemini Era)** |
<!-- MONTHLY_SURGE_END -->
