...
- [ibm.com: Multizone Kubernetes and VPC Load Balancer Setup](https://www.ibm.com/think) Securely expose your Kubernetes app by setting up a Load Balancer for VPC in a different zone.
