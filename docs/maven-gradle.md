...
- [twitter.com/ASFMavenProject: The official twitter feed of the Apache Maven Project](https://x.com/ASFMavenProject)
- [twitter.com/ASFMavenRelease: Maven Plugin Release](https://x.com/ASFMavenRelease) Tweets of plugin releases
