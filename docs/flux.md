...
- [docs.fluxcd.io](https://docs.fluxcd.io/en/1.22.2)
- [github: Flux](https://github.com/fluxcd/flux)
- [github: Flux Version 2](https://github.com/fluxcd/flux2)
- [toolkit.fluxcd.io: GitOps Toolkit 🌟](https://fluxcd.io/flux) Great docs for the GitOps toolkit
...
- [docs.microsoft.com: Configurations and GitOps with Azure Arc enabled Kubernetes](https://learn.microsoft.com/en-us/azure/azure-arc/kubernetes/conceptual-gitops-flux2)
...
- [weave.works: Flamingo: Expand Argo CD with Flux](https://www.weave.works/)
...
- [github.com/onedr0p/flux-cluster-template: Template for deploying k3s backed by Flux](https://github.com/onedr0p/cluster-template) Highly opinionated template for deploying a single Kubernetes (k3s) cluster with Ansible and Terraform backed by Flux, SOPS, GitHub Actions, Renovate and more!
