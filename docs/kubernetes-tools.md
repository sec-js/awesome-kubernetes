...
7. [Curl](#curl)
8. [kcp](#kcp)
9. [Clusternet](#clusternet)
10. [Open Cluster Management](#open-cluster-management)
11. [Penetration Testing Tools](#penetration-testing-tools)
12. [Deckhouse Kubernetes Platform](#deckhouse-kubernetes-platform)
13. [KubeIP (GKE)](#kubeip-gke)
14. [Porter](#porter)
15. [Datree. Quality Checks for Kubernetes YAMLs](#datree-quality-checks-for-kubernetes-yamls)
16. [Kaniko Build Images in Kubernetes without docker](#kaniko-build-images-in-kubernetes-without-docker)
17. [Shipwright Framework for Building Container Images on Kubernetes](#shipwright-framework-for-building-container-images-on-kubernetes)
18. [BuildKit CLI for kubectl](#buildkit-cli-for-kubectl)
19. [Buildpacks vs Dockerfiles](#buildpacks-vs-dockerfiles)
20. [Kubevela](#kubevela)
21. [Pixie. Instantly troubleshoot applications on Kubernetes](#pixie-instantly-troubleshoot-applications-on-kubernetes)
22. [Dekorate. Generate k8s manifests for java apps](#dekorate-generate-k8s-manifests-for-java-apps)
23. [Kubesploit](#kubesploit)
24. [Kubeshop](#kubeshop)
25. [Meshery](#meshery)
26. [Monokle](#monokle)
27. [K8studio](#k8studio)
28. [KubeLibrary](#kubelibrary)
29. [kube-vip](#kube-vip)
30. [Kubermetrics](#kubermetrics)
31. [Kustomizer](#kustomizer)
32. [MetalLB](#metallb)
33. [Kubermatic Kubernetes Platform](#kubermatic-kubernetes-platform)
    1. [Kubermatic Kubeone](#kubermatic-kubeone)
34. [Usernetes](#usernetes)
35. [k8syaml.com](#k8syamlcom)
36. [Popeye](#popeye)
37. [kbrew](#kbrew)
38. [KubExplorer](#kubexplorer)
39. [Kubescape](#kubescape)
40. [Kubectl Connections](#kubectl-connections)
41. [Benchmark Operator](#benchmark-operator)
42. [Source-To-Image (S2I)](#source-to-image-s2i)
43. [VMware Tanzu Octant](#vmware-tanzu-octant)
44. [Qovery Engine](#qovery-engine)
45. [mck8s Container orchestrator for multi-cluster Kubernetes](#mck8s-container-orchestrator-for-multi-cluster-kubernetes)
46. [Shipwright framework](#shipwright-framework)
47. [Schiff (Deutsche Telekom)](#schiff-deutsche-telekom)
48. [NetMaker](#netmaker)
49. [AWS Karpenter kubernetes Autoscaler](#aws-karpenter-kubernetes-autoscaler)
50. [Kuby (easy deployments of Ruby Rails App)](#kuby-easy-deployments-of-ruby-rails-app)
51. [Direktiv](#direktiv)
52. [Jabos](#jabos)
53. [Pleco](#pleco)
54. [Mesh-kridik](#mesh-kridik)
55. [kubewatch](#kubewatch)
56. [Botkube](#botkube)
57. [Robusta](#robusta)
58. [Soup GitOps Operator](#soup-gitops-operator)
59. [Epinio](#epinio)
60. [Testkube](#testkube)
61. [KuberLogic](#kuberlogic)
62. [Kusk](#kusk)
63. [Azure AD Workload Identity](#azure-ad-workload-identity)
64. [Kubernate](#kubernate)
65. [Tackle](#tackle)
...
- [jspolicy](https://github.com/loft-sh/jspolicy) jsPolicy is an operator that helps you define Kubernetes Policies using JavaScript or TypeScript. Easier & Faster Kubernetes Policies using JavaScript or TypeScript.
    - [blog.ediri.io: Writing Kubernetes policies with jsPolicy and deploy them via FluxCD](https://blog.ediri.io/writing-kubernetes-policies-with-jspolicy) how to write Kubernetes policies using JavaScript/Typescript with the help of jsPolicy and deploy them via GitOps using Flux
...
- [cloudnativesimplified.substack.com: kcp: Kubernetes-like control plane](https://cloudnativesimplified.substack.com/p/tool-series-1-kcp) kcp is a control plane for workloads on many clusters. you will explore how to use it to manage multiple tenants:
...
- [medium.com/@charled.breteche: Kind, Cilium, MetalLB, and still no kube-proxy](https://medium.com/@charled.breteche/kind-cilium-metallb-and-no-kube-proxy-a9fe66ddfad6)I will show you how to add MetalLB into the mix to enable services of type LoadBalancer to work in your local cluster.
...
- [itnext.io: Configuring routing for MetalLB in L2 mode](https://itnext.io/configuring-routing-for-metallb-in-l2-mode-7ea26e19219e) you will discover how to configure source-based and policy-based routing for the external network on your cluster using MetalLB
...
- [infracloud.io: Securing Kubernetes Cluster using Kubescape and kube-bench](https://www.infracloud.io/blogs/securing-kubernetes-cluster-kubescape-kubebench) you will discuss how you can secure a Kubernetes cluster using Kubescape and kube-bench
...
- [salaboy.com: Building platforms on top of Kubernetes: VCluster and Crossplane](https://www.salaboy.com/2022/08/03/building-platforms-on-top-of-kubernetes-vcluster-and-crossplane) you'll learn how to:
...
- [kubetools.io: Why K9s Should Be Your Go-To Tool for Kubernetes Management](https://kubetools.io/why-k9s-should-be-your-go-to-tool-for-kubernetes-management)
...
- [kubetools.io: KoPylot: An AI-Powered Kubernetes Assistant for DevOps & Developers](https://kubetools.io/kopylot-an-ai-powered-kubernetes-assistant-for-devops-developers)
- [chat.openai.com: Kube Debugger: A Kubernetes error debugger offering diagnostic and resolution guidance.](https://chatgpt.com/g/g-TCE8R7bcL-kube-debugger) You can copy and paste your Kubernetes error into the prompt, and the Kube debugger will give you step-by-step instructions to troubleshoot. This GPT will reduce the amount of time you spend troubleshooting Kubernetes errors. It requires the ChatGPT plus subscription.
