...
- [==learnk8s.io: A visual guide on troubleshooting Kubernetes deployments== 🌟](https://learnkube.com/troubleshooting-deployments)
...
- [youtube: 3 Ways to Detect Evil "Latest" Image Tags in Kubernetes - Kubevious](https://www.youtube.com/watch?v=93RlMqO4glM&t=6s&ab_channel=Kubevious) The "latest" image tag is a disaster waiting to happen. you will learn how to detect usage of the latest images using 3 different methods.
...
- [==blog.alexellis.io: How to Troubleshoot Applications on Kubernetes== 🌟](https://blog.alexellis.io/troubleshooting-on-kubernetes) a practical framework to troubleshoot applications deployed on Kubernetes:
    - Is it there?
...
- [devzero.io: Kubernetes Debugging Tips](https://www.devzero.io/blog/kubernetes-autoscaling)
...
- [==komodor.com: Exit Codes In Containers & Kubernetes – The Complete Guide==  🌟](https://komodor.com/learn/exit-codes-in-containers-and-kubernetes-the-complete-guide) everything there is to know about exit codes used by container engines to indicate reasons for container termination.
...
- [sysdig.com: What is Kubernetes CrashLoopBackOff? And how to fix it 🌟](https://www.sysdig.com/blog/debug-kubernetes-crashloopbackoff) CrashLoopBackOff is a Kubernetes state representing a restart loop that is happening in a Pod: a container in the Pod is started but crashes and is then restarted over and over again. Learn what it is and how to fix it in this article
...
- [sysdig.com: Understanding Kubernetes Evicted Pods](https://www.sysdig.com/blog/kubernetes-pod-evicted) What does it mean that Kubernetes Pods are evicted? They are terminated, usually due to a lack of resources. But why does this happen?
...
- [==loft.sh: Using Kubernetes Ephemeral Containers for Troubleshooting==](https://www.vcluster.com/blog/using-kubernetes-ephemeral-containers-for-troubleshooting)
...
- [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) Collection of gadgets for debugging and introspecting Kubernetes applications using BPF
...
- [medium: Better Debugging Environment for your Micro-Services](https://medium.com/@moshe.beladev.mb/better-debugging-environment-for-your-micro-services-9420a71b8a37)
- [codefresh.io: Using Telepresence 2 for Kubernetes debugging and local development](https://octopus.com/devops)
...
- [rookout.com: The Definitive Guide To Kubernetes Application Debugging](https://www.dynatrace.com/solutions/observability-for-developers)
...
- [medium.com/@danielepolencic: Isolating kubernetes pods for debugging](https://medium.com/@danielepolencic/isolating-kubernetes-pods-for-debugging-5fe41e630e9)a technique that helps you with debugging running Pods in production by changing labels, you can detach Pods from the Service (no traffic), and you troubleshoot them live
- [medium.com/adaltas: Kubernetes: debugging with ephemeral containers](https://medium.com/adaltas/kubernetes-debugging-with-ephemeral-containers-e4be659d9ef6) how to debug pods using kubectl debug and ephemeral containers
...
- [kubetools.io: Kubeshark – API Traffic Analyzer for Kubernetes](https://kubetools.io/mastering-kubernetes-debugging-and-troubleshooting-with-kubeshark-real-time-visibility-query-language-service-map-and-integrations)
...
??? note "Click to expand!"
    ...
    [![learnk8s debug your pods](images/learnk8s_debug_your_pods.png){: style="width:30%"}](https://learnkube.com/troubleshooting-deployments)
